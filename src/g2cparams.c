...
static G2C_PARAM_T param[G2C_MAX_NOAA_PARAMS] = {
    ...
    {255, 255, 2, 2, 40, "PEVAPTRAT"},
    {255, 255, 2, 2, 41, "SMRATE"},
    {255, 255, 2, 2, 42, "WRDRATE"},
    {255, 255, 2, 2, 43, "DRAINDIR"},
    {255, 255, 2, 2, 44, "UPSAREA"},
    {255, 255, 2, 2, 45, "WETCOV"},
    {255, 255, 2, 2, 46, "WETTYPE"},
    {255, 255, 2, 2, 47, "IRRCOV"},
    {255, 255, 2, 2, 48, "CROPCOV"},
    {255, 255, 2, 2, 49, "GRASSCOV"},
    {255, 255, 2, 2, 50, "SKINRC"},
    {255, 255, 2, 2, 51, "SURFRATE"},
    {255, 255, 2, 2, 52, "SUBSRATE"},
    {255, 255, 2, 2, 53, "LOVEGCOV"},
    {255, 255, 2, 2, 54, "HIVEGCOV"},
    {255, 255, 2, 2, 55, "LAILO"},
    {255, 255, 2, 2, 56, "LAIHI"},
    {255, 255, 2, 2, 57, "TYPLOVEG"},
    {255, 255, 2, 2, 58, "TYPHIVEG"},
    {255, 255, 2, 2, 59, "NECOFLUX"},
    {255, 255, 2, 2, 60, "GROSSFLUX"},
    {255, 255, 2, 2, 61, "ECORFLUX"},
    {255, 255, 2, 2, 62, "EMISS"},
    {255, 255, 2, 2, 63, "CANTMP"},
    {255, 255, 2, 2, 233, "LANDFRC"},
    {255, 255, 2, 2, 234, "LAKEFRC"},
    {255, 255, 2, 2, 235, "PAHFLX"},
    {255, 255, 2, 2, 236, "WATERSA"},
    {255, 255, 2, 2, 237, "EIWATER"},
    {255, 255, 2, 2, 238, "PLANTTR"},
    {255, 255, 2, 2, 239, "SOILSE"},
};
