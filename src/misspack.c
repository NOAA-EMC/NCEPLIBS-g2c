 ...
 * Template 5.2 or 5.3 with the appropriate values. This version
 * assumes that Missing Value Management is being used and that 1 or 2
 * missing values appear in the data.
 *
