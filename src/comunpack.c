 ...
 * PROGRAM HISTORY LOG:
 * - 2002-10-29  Gilbert
 * - 2004-12-16 Gilbert Added test (provided by Arthur Taylor/MDL) to
 *   verify that group widths and lengths are consistent with section
 *   length.
 *
 * @param cpack pointer to the packed data field.
 * @param lensec length of section 7 (used for error checking).
 * @param idrsnum Data Representation Template number 5.N Must equal 2
 * or 3.
