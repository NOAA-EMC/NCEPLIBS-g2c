/** @file
 *
 * @brief This inculde file contains info on all the available GRIB2
 * Product Definition Templates used in Section 4 (PDS). The
 * information decribing each template is stored in the pdstemplate
 * structure defined below.
 *
 * Each Template has three parts: The number of entries in the
 * template (mappdslen); A map of the template (mappds), which
 ...
 * "static" part of the template. ( See Template 4.3 as an example )
 *
 ...
 *
 * @author Stephen Gilbert @date 2005-12-08
 */
