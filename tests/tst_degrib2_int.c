...
#define DATE_TIME_LEN 100
        int prod_template_num[NUM_PROD_TEST] = {0, 0, 0, 0, 8, 2, 0, 2};
        ...
        char expected_level_desc[NUM_PROD_TEST][G2C_MAX_GRIB_LEVEL_DESC_LEN + 1] = {
            ...
            " Surface", "0 - .1 m DBLY", " 0 - .10 m DBLY", " Mean Sea Level"};
        char level_desc[G2C_MAX_GRIB_LEVEL_DESC_LEN + 1];
        short year[NUM_PROD_TEST] = {2021, 2022, 2022, 2022, 2022, 2022, 2022, 2022};
        unsigned char month[NUM_PROD_TEST] = {11, 11, 11, 11, 11, 11, 11, 11};
        unsigned char day[NUM_PROD_TEST] = {30, 6, 6, 6, 17, 17, 17, 17};
        unsigned char hour[NUM_PROD_TEST] = {0, 12, 12, 12, 19, 12, 12, 12};
        unsigned char minute[NUM_PROD_TEST] = {0, 0, 0, 0, 0, 0, 0, 0};
        unsigned char second[NUM_PROD_TEST] = {0, 0, 0, 0, 0, 0, 0, 0};
