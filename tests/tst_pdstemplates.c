...
#define NUM_TEST 51
        int number[NUM_TEST] = {
            ...
            51, 91, 33, 34, 53, 54, 57, 60, 61, 35, 49, 55, 58, 59};
        int expected_maplen[NUM_TEST] = {
            ...
            36, 18, 32, 19, 22, 7, 24, 38, 6, 29, 21, 7, 24};
...
#define NUM_EXT_TEST 26
                ...
                int expected_extlen[NUM_EXT_TEST] = {2, 2, 6, 6, 6, 6, 6, 8, 8, 10, 10, 6, 6, 10, 6, 6, 12, 8, 2, 8, 2, 2, 30, 6, 10, 36};
